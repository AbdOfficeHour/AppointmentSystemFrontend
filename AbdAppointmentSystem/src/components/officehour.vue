        ...
        <el-form-item label="选择老师" prop="teacher">
            <el-select v-model="ruleForm.teacher" placeholder="选择老师">
                <el-option v-for="item in teachers" :key="item.teacherID" :label="item.teacherName"
                    :value="item.teacherID" @click="getTime" />
    ...
    usefulTime.value = [
        {
            ...
            "times": [
                {
                    "startTime": 1720294200000,
                    "endTime": 1720297800000
                }, {
                    "startTime": 1720312200000,
                    "endTime": 1720319400000
                }
            ]
        },
        {
            ...
            "times": [
                {
                    "startTime": 1720404000000,
                    "endTime": 1720411200000
                }, {
                    "startTime": 1720418400000,
                    "endTime": 1720425600000
                }
            ]
        },
    ]
